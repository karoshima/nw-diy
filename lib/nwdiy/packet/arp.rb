...
# ARP フレームの定義
#
# arp = NwDiy::Packet::ARP.new
#    初期化された ARP フレームを作成します。
#
# arp = NwDiy::Packet::ARP.new(バイナリデータ)
#    バイナリデータをパケットデータとして読み込み、ARP フレームを作成します。
#
# arp.hard, arp.prot, arp.hlen, arp.plen
#    ARP フレームの各フィールドを読み書きします。
#
# arp.bytesize
#    ARP フレームのバイト長を返します
# 
# arp.to_pkt
#    ARP フレームをバイナリデータ化します
#
# arp.to_s
#    ARP フレームを可読化します
#
